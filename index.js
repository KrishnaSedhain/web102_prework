...
const unfundedText = unfundedCount === 1
  ? '1 game remains unfunded.'
  : `${unfundedCount.toLocaleString()} games remain unfunded.`;
  const description = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames.toLocaleString()} games. ${unfundedText}`;
